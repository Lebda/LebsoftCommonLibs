...
namespace Areas_Help.AreaSelection
{
    public class AreaHttpControllerSelector : DefaultHttpControllerSelector
    {
        private const string c_areaRouteVariableName = "area";
            ...
            : base(configuration)
        {
            ...
            m_apiControllerTypes = new Lazy<ConcurrentDictionary<string, Type>>(GetControllerTypes);
        }
        ...
        private static string GetAreaName(HttpRequestMessage request)
        {
            ...
            {
                object areaName;
                return data.Route.DataTokens.TryGetValue(c_areaRouteVariableName, out areaName) ? areaName.ToString() : null;
            }
        }
        ...
        private HttpControllerDescriptor GetApiController(HttpRequestMessage request)
        {
            ...
            return new HttpControllerDescriptor(m_configuration, controllerName, type);
        }
        private Type GetControllerType(string areaName, string controllerName)
        {
            var query = m_apiControllerTypes.Value.AsEnumerable();
